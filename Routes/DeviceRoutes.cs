...
namespace Gaos.Routes
{
    ...
    public static class DeviceRoutes
    {
        ...
        public static RouteGroupBuilder GroupDevice(this RouteGroupBuilder group)
        {
            ...
            group.MapPost("/register1", async (DeviceRegisterRequest deviceRegisterRequest, Db db, UserService userSerice, HttpContext context, GameData gameData) =>
            {
                const string METHOD_NAME = "device/register1";
                try
                {
                    DeviceRegisterResponse response;
                    UserInterfaceColors userColors = null;
